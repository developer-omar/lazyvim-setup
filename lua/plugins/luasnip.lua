return {
  ...
  },
  {
    ...
    opts = function(_, opts)
      ...
      ls.filetype_extend("typescript", { "typescript", "common-js-ts", "todos", "react", "vue-ts", "vitest" })
      ls.filetype_extend("typescriptreact", { "typescript", "common-js-ts", "todos", "react", "vitest" })
      ls.filetype_extend("vue", { "typescript", "common-js-ts", "todos", "vue" })
